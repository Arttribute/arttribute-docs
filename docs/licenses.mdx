...
> **Note**: Until our new licensing framework is fully launched, we recommend using Creative Commons licence and [Arttribute's permission requests](/permission-request) to ensure mutual understanding regarding the usage rights of any artwork on Arttribute.
