...
axios
  .request({
    ...
    url: "https://dev.api.arttribute.io/v1/items",
    headers: {
      "x-api-key": "17eoF8...",
...
curl --location 'https://dev.api.arttribute.io/v1/items' \
...
let config = {
  method: "get",
  maxBodyLength: Infinity,
  url: "https://dev.api.arttribute.io/v1/items/:id",
  headers: {
...
curl --location 'https://dev.api.arttribute.io/v1/items/:id' \
...
axios
  .request({
    method: "get",
    maxBodyLength: Infinity,
    url: "https://dev.api.arttribute.io/v1/items?tags=cgi,art&source=instagram",
    headers: {
...
```bash title="Making a GET request with cURL"
curl --location 'https://dev.api.arttribute.io/v1/items?tags=cgi%2Cart&source=instagram' \
...
curl --location --request PATCH 'https://dev.api.arttribute.io/v1/items/:id' \
...
curl --location --request DELETE 'https://dev.api.arttribute.io/v1/items/:id' \
--header 'Authorization: Bearer eyJhbGciOiJIU...'
```
